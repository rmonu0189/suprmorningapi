...
final class Database
{
    ...
    private static function ensureDevAdminSeed(PDO $pdo): void
    {
        ...
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_push_notification_devices_user ON push_notification_devices(user_id)');
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_push_notification_devices_provider ON push_notification_devices(provider)');
