...
CREATE TABLE IF NOT EXISTS users (
    ...
    original_phone VARCHAR(20) NULL,
    ...
    deactivation_reason_code VARCHAR(64) NULL,
    deactivation_reason_text TEXT NULL,
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS products (
    ...
    tags JSON NULL,
    status TINYINT(1) NOT NULL DEFAULT 1,
    is_subscribable TINYINT(1) NOT NULL DEFAULT 1,
    metadata JSON NULL,
    PRIMARY KEY (id),
    ...
    KEY idx_products_subscribable (is_subscribable),
